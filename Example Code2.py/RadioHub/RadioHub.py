...
from RadioHub.ServiceAccessPoints.LoRaMeshRouter import LoRaMeshRouter
...
class RadioHub:
    ...
    def __init__( self ):
        ...
        self.serviceAccessPointsByName = {}
    ...
    def open( self, portName, client ) -> bool:
        ...
        self.serviceAccessPointsByName[ "DeviceMgmt" ] = self.deviceManagement

        # create LoRaMeshRouter SAP
        self.LoRaMeshRouter = LoRaMeshRouter( client = client, serialDevice = self.serialDevice, sap_id = ServiceAccessPoint_ID.LoRaMeshRouter ) 
        # and add to dictionary
        self.serviceAccessPoints[ ServiceAccessPoint_ID.LoRaMeshRouter ] = self.LoRaMeshRouter
        self.serviceAccessPointsByName[ "LoRaMeshRouter" ] = self.LoRaMeshRouter
    ...
    def radioRequest( self, service, params ):
        parts = service.split( '.' )
        moduleName = parts[ 0 ]
        serviceName = parts[ 1 ]
        self.serviceAccessPointsByName[ moduleName ].radioRequest( serviceName, params )
