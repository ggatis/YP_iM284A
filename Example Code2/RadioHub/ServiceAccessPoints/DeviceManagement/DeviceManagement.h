...
public:
     ...
     */
    bool                                OnSetSystemOptions          ( const QJsonObject& params );
...
private:
    ...
    bool                                OnStartupIndication         ( const SerialMessage& serialMsg, QJsonObject& result );
    bool                                OnDeviceInfoResponse        ( const SerialMessage& serialMsg, QJsonObject& result );
    bool                                OnFirmwareVersionResponse   ( const SerialMessage& serialMsg, QJsonObject& result );
    bool                                OnDateTimeResponse          ( const SerialMessage& serialMsg, QJsonObject& result );
    bool                                OnSystemOptionsResponse     ( const SerialMessage& serialMsg, QJsonObject& result );

    QJsonObject                         DecodeDeviceInfo            ( const SerialMessage& serialMsg, int index ) const;
    QJsonObject                         DecodeFirmwareInfo          ( const SerialMessage& serialMsg, int index ) const;
