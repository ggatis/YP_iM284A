...
public:
     ...
     * @param   index   index to array
     */
    QString     GetString( int index , int size = -1 ) const;
     ...
     * @param   index   index to array
     */
    QString     GetHexString( int index, int size = -1 ) const;
     ...
     * @param   index   index to array
     */
    QString     GetHexString_LSB( int index, int size = -1 ) const;
     ...
     * @param   index   index to array
     */
    QString     GetDateTime( int index, const QString& formatString ) const;
     ...
     */
    int         AppendHexString( const QString& input );
     ...
     * @return  number of appended bytes
     */
    int         AppendHexString_LSB( const QString& input );
